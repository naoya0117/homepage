            ...
            <div className="flex flex-row justify-between">
                <div className="flex flex-col w-full">
                    ...
                    <div className="bg-blue-100">
                        ...
                        <div className="bg-blue-100 mt-40">
                            <div className="mx-auto"></div>
                            <h2 className="text-center text-4xl mb-4">Project</h2>
                            <h3 className="text-center text-2xl mb-4 mt-4">個人開発</h3>
                            <div className="flex flex-row flex-wrap justify-center">
                                <CustomCard title="vim-tetris" summary="vimのモードや操作を搭載したテトリスです。viを楽しく学べるように作りました。pthreadで並列処理を行っています" techTags={['C', 'Bash', 'docker', 'ncurses', 'pthread']} repoUrl='https://github.com/naya0117/vim_tetris.git' />
                            ...
                            <div className="flex flex-row flex-wrap justify-center">
                                ...
                                <CustomCard title="カレンダー" summary="所属グループ内で、予定を共有できるカレンダーアプリを開発しました。非同期で予定が最新の予定が自動で画面に反映されるようにしています。" techTags={['Spring boot', 'H2DB', 'Java', 'html', 'css']} repoUrl='https://gitub.com/e1b21007/schedule.git' />
                            </div>
